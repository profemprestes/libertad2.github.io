...
import { CalendarDays, Instagram, ShieldHalf, UserCircle } from 'lucide-react';
import Link from 'next/link';

interface Sub15PlayerCardProps {
  player: Sub15Player;
}

export function Sub15PlayerCard({ player }: Sub15PlayerCardProps) {
  return (
