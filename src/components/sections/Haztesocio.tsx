...
import { HazteSocioModal } from '@/components/club/HazteSocioModal'; 
      ...
      <section id="hazte-socio" className="py-20 md:py-28 bg-gradient-to-br from-primary via-red-600 to-accent text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-background/10 p-6 rounded-xl shadow-lg hover:scale-105 transition-transform duration-300 backdrop-blur-sm">
              <ChevronRight className="mx-auto mb-4 h-10 w-10 text-accent" strokeWidth={2.5} />
          ...
          <Button 
            size="lg" 
            className="bg-background text-primary font-bold rounded-lg shadow-xl hover:bg-accent hover:text-accent-foreground transition-colors text-lg px-8 py-4"
